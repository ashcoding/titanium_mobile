...
public class TiUICardView extends TiUIView
{
	...
	public void processProperties(KrollDict d)
	{
		...
		if (d.containsKey(TiC.PROPERTY_CARD_USE_COMPAT_PADDING)) {
			cardview.setUseCompatPadding(TiConvert.toBoolean(d, TiC.PROPERTY_CARD_USE_COMPAT_PADDING, true));
		}
		...
		if (d.containsKey(TiC.PROPERTY_CARD_PREVENT_CORNER_OVERLAP)) {
			cardview.setPreventCornerOverlap(TiConvert.toBoolean(d, TiC.PROPERTY_CARD_PREVENT_CORNER_OVERLAP, true));
		}
	...
	public void propertyChanged(String key, Object oldValue, Object newValue, KrollProxy proxy)
	{
		...
		if (key.equals(TiC.PROPERTY_CARD_BACKGROUND_COLOR)) {
			...
			cardview.setPreventCornerOverlap(TiConvert.toBoolean(newValue, true));
			cardview.requestLayout();
		} else if (key.equals(TiC.PROPERTY_CARD_USE_COMPAT_PADDING)) {
			cardview.setUseCompatPadding(TiConvert.toBoolean(newValue, true));
			cardview.requestLayout();
